    ...
    return {
      ...
      meta: [
        // titles
        {
          hid: 'og:title',
          property: 'og:title',
          content: 'Tom Pain | Full stack engineer | MSc Computer Science',
        },
        {
          hid: 'twitter:title',
          name: 'twitter:title',
        ...
        },
        {
          hid: 'og:image',
          property: 'og:image',
          content: 'https://tompa.in/assets/images/jpg/packed-OG-image.jpg',
        },
        {
          hid: 'og:image2',
          property: 'og:image',
          content: 'https://tompa.in/assets/images/jpg/packed-OG-image2.jpg',
        },
        {
          hid: 'twitter:image',
          name: 'twitter:image',
          content:
            'https://tompa.in/assets/images/jpg/packed-twitter-image.jpg',
        },
        {
          hid: 'twitter:image',
          name: 'twitter:image',
